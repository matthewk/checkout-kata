...
class QuantityRuleSpec extends FunSpec with Matchers{
  describe("A Pricing Rule") {
    ...
    it("should calculate the correct SubTotal for a basket with matching items") {
    ...
    it("should calculate the correct SubTotal for a basket with multiple matching items") {
      val item = Item("A".toSKU, Price(10))
    ...
    it("should calculate the correct SubTotal for a basket with exact multiple matching items") {
      val item = Item("A".toSKU, Price(10))
    ...
    it("should calculate the correct SubTotal for a basket with no matching items") {
    ...
    it("should be able to evaluate on a SubTotal") {
      val nonMatchingItem = Item("A".toSKU, Price(10))
      val item = Item("B".toSKU, Price(5))
